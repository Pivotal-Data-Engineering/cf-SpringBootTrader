...
if __name__ == '__main__':
    ...
    renderTemplate(here,'network.json.tpl', context)
    print('network.json rendered')
    ...
    stackSummary = None
    stackName = context['EnvironmentName'] + "Network"
    ...
    with open('network.json', 'r') as cfFile:
    ...
    #TODO would be nice to output a summary
